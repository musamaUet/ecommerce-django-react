...
class Product(models.Model):
    ...
    numReviews = models.DecimalField(max_digits = 7, decimal_places = 2, null = True, blank = True)
    price = models.DecimalField(max_digits = 7, decimal_places = 2, null = True, blank = True)
    countInStock = models.DecimalField(max_digits = 7, decimal_places = 2, null = True, blank = True, default = 0)
...
class ShippingAddress(models.Model):
    ...
    shippingPrice = models.DecimalField(max_digits=7, decimal_places = 7, null = True, blank = True)
    _id = models.AutoField(primary_key=True, editable=False)
